...
<div class="container-fluid">
	<form action="" id="product-form">
		...
		<div class="form-group">
			<label for="retailprice" class="control-label">Net Price</label>
			<input type="number" name="retailprice" id="retailprice" class="form-control form-control-sm rounded-0 text-right" value="<?php echo isset($retailprice) ? $retailprice : ''; ?>"  required/>
		</div>
		<div class="form-group">
