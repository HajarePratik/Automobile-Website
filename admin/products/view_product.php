...
<div class="container-fluid">
	...
	<dl>
        ...
        <dt class="text-muted">Product Description</dt>
        <dd class="pl-4"><?= isset($description) ? $description : '' ?></dd>
        <dt class="text-muted">MRP</dt>
        <dd class="pl-4"><?= isset($price) ? format_num($price) : '' ?></dd>
		 <dt class="text-muted">Net Price</dt>
        <dd class="pl-4"><?= isset($retailprice) ? format_num($retailprice) : '' ?></dd>
        <dt class="text-muted">Status</dt>
        <dd class="pl-4">
            <?php if($status == 1): ?>
                <span class="badge badge-success px-3 rounded-pill">Available</span>
            <?php else: ?>
                <span class="badge badge-danger px-3 rounded-pill">Not Available</span>
            <?php endif; ?>
        </dd>
    </dl>
